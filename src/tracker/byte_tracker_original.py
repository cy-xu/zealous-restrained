...
class BYTETracker_original(object):
    ...
    def update(self, output_results, img_info, img_size):
        ...
        # add for ADAP annotation tool
        self.tracks_per_frame[self.frame_id] = [t.custom_copy() for t in self.tracked_stracks if t.is_activated]
        self.frame_id += 1
